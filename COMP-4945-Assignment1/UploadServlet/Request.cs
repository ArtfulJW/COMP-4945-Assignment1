    ...
    public class Request
    {
        ...
        public void parsePayload()
        {
            ...
            for (int i = 0; i < req.Length; i++)
            {
                ...
                if (req[i].Contains("Content-Type: image/png") || req[i].Contains("Content-Type: image/jpeg") || req[i].Contains("Content-Type: image/jpg"))
                {
                    ...
                    byte[] imgBytes = byteList.ToArray();
                    ...
                    if (userAgent == "CLI")
                    {
                        ...
                        string base64String = Encoding.ASCII.GetString(byteList.ToArray());
                        imageByteData = Convert.FromBase64String(base64String);
                    }
                    else
                    {                                                
                       
                        imageByteData = byteList.ToArray();
                    }
                ...
                {
                    string file = req[i].Split("filename=\"")[1];                    
